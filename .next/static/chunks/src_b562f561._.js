...
function AuthProvider({ children }) {
    ...
    const login = async (username, password)=>{
        try {
            const userData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])(username, password);
            setUser(userData);
    ...
    const register = async (username, email, password)=>{
        try {
            const userData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["register"])(username, email, password);
            setUser(userData);
            localStorage.setItem('user', JSON.stringify(userData));
        } catch (error) {
...
class SocketService {
    ...
    connect(token) {
        this.socket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$socket$2e$io$2d$client$2f$build$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["io"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_SOCKET_URL || 'http://localhost:3001', {
            auth: {
                token
            }
        });
    ...
    sendVoiceData(audioData, channelId) {
        if (!this.socket) throw new Error('Not connected to WebSocket server');
...
"[project]/src/components/providers/ChatProvider.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ChatProvider({ children }) {
    ...
    const [currentChannel, setCurrentChannel] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatProvider.useEffect": ()=>{
            if (user?.token) {
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["socketService"].connect(user.token);
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["socketService"].onMessage({
                ...
                return ({
                    "ChatProvider.useEffect": ()=>{
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["socketService"].disconnect();
                    }
                })["ChatProvider.useEffect"];
            }
        }
    ...
    const sendMessage = (content, type = 'text')=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["socketService"].sendMessage({
            content,
    ...
    const joinChannel = (channelId)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["socketService"].joinChannel(channelId);
    ...
    const leaveChannel = (channelId)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["socketService"].leaveChannel(channelId);
    ...
    const startVoiceChat = async (channelId)=>{
        try {
            ...
            processor.onaudioprocess = (e)=>{
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["socketService"].sendVoiceData(audioData.buffer, channelId);
            };
            setIsVoiceChatActive(true);
            // Handle incoming voice data
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["socketService"].onVoiceData(({ userId, audioData })=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ChatContext.Provider, {
        ...
        fileName: "[project]/src/components/providers/ChatProvider.tsx",
        lineNumber: 122,
        columnNumber: 5
    }, this);
}
_s1(ChatProvider, "WWwdxkDdRoADV0B3v6MQkM5CEUI=", false, function() {
    return [
...
//# sourceMappingURL=src_b562f561._.js.map